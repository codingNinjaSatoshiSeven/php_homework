  ...
  <body>
    <div class="container">
      ...
      <?php
        ...
        $result2 = $product->get_user_highest_rating($user_id);
        $result3 = $uservisitedpage->get_user_most_visited_pages($user_id);

       
        echo"<div><label>User Top Rated Item</label></div>";
        while($row2 = $result2->fetch_assoc()) {
          echo"<div>" .$row2['display_name']. " " .$row2['avg_rating']. "</div>";
        }
        echo"<div><label>User Most Visited Place</label></div>";
